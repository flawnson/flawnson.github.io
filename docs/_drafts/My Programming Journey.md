...
Created: Jan 5, 2020 10:40 AM
Edited: Oct 22, 2020 8:49 PM
Publicised: Yes
Topic: Programming

[https://storage.googleapis.com/slite-api-files-production/files/5da14caf-af09-4519-903c-68d4d2a94a0d/imported-image](https://storage.googleapis.com/slite-api-files-production/files/5da14caf-af09-4519-903c-68d4d2a94a0d/imported-image)
...
- Watch Andrew’s Ng’s talk on [A.I as the next Electricity](https://www.youtube.com/watch?v=fgbBtnCvcDI), he also provides some great next steps for those that want to break into the industry.
...
- Intermediate programming
    - Thorough knowledge and familiarity with advanced programming concepts like functions and classes is necessary. The quality of your programs will be hugely advanced, and some tools require knowledge in these concepts
        ...
        - Bonus: Also start learning [vim](http://www2.geog.ucl.ac.uk/~plewis/teaching/unix/vimtutor)
            ...
            - Let yourself fail and watch in awe as people on [vimgolf](https://www.vimgolf.com/) obliterate your ego
- Advanced Programming
    - To reach this point, one should have a strong foundation built with OOP, Data structures/Algorithms, and skills with some handy dev tools. Fluency in at least one language as well as some background in other languages (ideally that which is different from your native language) is also a must
...
- Language Specific Resources
    - Python
        ...
        - Codeacademy, something of a hazing for beginner programmers  — Just don’t use this alone and call it a day.
...
## Bonus: Information Theory

- Probably not going to be as useful until you reach variational methods. There are certain concepts that require an understanding of entropy (not Physics) in information theory. In general, Information theory will give you a very strong intuition in machine learning and data science, particularly when you are thinking of new algorithms and methods.
- Information Theory is the leading field os study that is helping researchers understand what is going on inside neural networks, which are notoriously known for being “black boxes”. Papers like [this](https://arxiv.org/pdf/1703.00810.pdf) highlight the possibilities (for a gentle introduction, check out [this video](https://www.youtube.com/watch?v=pFWiauHOFpY&feature=youtu.be))
...
- Bleeding edge A.I. Can be seen as a training method rather than a specific model type. Key component of many modern A.I innovations

### Evolutionary and Genetic algorithms

- Evolutionary and Genetic A.I aren't as flashy as Deep Learning, but it plays a huge role in Machine Learning research. A.I inspired by the theory of evolution, natural selection, and genetic variance.

### Swarm Intelligence

- Swarm intelligence is as cool as it is highly relevant. This type of A.I takes inspiration from the concept of how some things form to be greater than the sum of its parts. Particularly useful for those interested in naturally occurring phenomenon such as the human complement system, bacterial and viral interactions, etc.
